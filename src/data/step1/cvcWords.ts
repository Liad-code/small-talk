...
export const CVC_WORDS: CVCWord[] = [
  ...
  { word: 'pin', vowel: 'i', emoji: '📌', consonantStart: 'p', consonantEnd: 'n' },
  ...
  { word: 'top', vowel: 'o', emoji: '🎵', consonantStart: 't', consonantEnd: 'p' },
...
export const VOWEL_COLORS: Record<Vowel, { bg: string; border: string; text: string; gradient: string }> = {
  ...
  o: { bg: 'bg-orange-100', border: 'border-orange-400', text: 'text-orange-700', gradient: 'from-orange-400 to-amber-400'  },
  u: { bg: 'bg-purple-100', border: 'border-purple-400', text: 'text-purple-700', gradient: 'from-purple-400 to-violet-400' },
}
