...
export const PA_EX1: PAEx1Q[][] = [
  ...
  [
    ...
    { sentence: 'You have a pencil.',          blank: '___ pencil is blue.',    options: ['Your', 'My'],    answer: 'Your'  },
    ...
    { sentence: 'I have a brother.',           blank: '___ name is Omer.',      options: ['My',   'His'],   answer: 'His'   },
  ],
]
