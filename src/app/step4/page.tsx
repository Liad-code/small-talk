...
export default function Step4Page() {
  ...
  const step4Stars = starsFor('step4')
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="text-center py-8 px-4">
        ...
        <h1 className="font-display text-4xl sm:text-5xl font-bold text-rose-700 mb-2">
          Step 4
        </h1>
        <p className="text-xl font-bold text-rose-600 mb-1">Advanced Phonics, Sight Words and Grammar!</p>

        {step4Stars > 0 && (
          <div className="inline-flex items-center gap-2 mt-4 bg-yellow-100 border-2 border-yellow-300 rounded-2xl px-4 py-2">
            <span className="text-2xl">⭐</span>
            <span className="font-black text-yellow-700 text-lg">{step4Stars} stars earned!</span>
          </div>
        )}
      </section>
      ...
      <div className="max-w-2xl mx-auto px-4 pb-16 grid grid-cols-1 sm:grid-cols-2 gap-5">
        <TopicCard
          ...
          title="Phonics"
          hebrewTitle="פונטיקה"
          description="Advanced sounds, blends, k or c"
          hebrewDesc="צלילים מתקדמים, צירופים, k או c"
          color="from-rose-400 to-red-500"
          textColor="text-white"
          available
        />
        <TopicCard
          href="/step4/sight-words"
          emoji="👁️"
          title="Sight Words"
          hebrewTitle=""
        ...
        <TopicCard
          ...
          title="Grammar"
          hebrewTitle="דקדוק"
          description="Present Simple & Progressive"
          hebrewDesc="הווה פשוט והווה ממושך"
