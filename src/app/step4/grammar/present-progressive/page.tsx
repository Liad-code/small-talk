...
export default function PresentProgressivePage() {
  return (
    <div className="min-h-screen">
      <Header />

      <div className="bg-gradient-to-r from-green-500 to-emerald-600 px-4 py-5">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-white/80 font-bold text-lg" dir="rtl">הווה ממושך</p>
        </div>
      </div>
      ...
      <div className="max-w-xl mx-auto px-4 py-16 text-center">
        ...
        <div className="mt-8">
          <Link href="/step4/grammar" className="btn-kid bg-green-500 no-underline inline-block">← Back to Grammar</Link>
        </div>
      </div>
    </div>
  )
