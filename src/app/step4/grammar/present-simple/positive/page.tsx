  ...
  if (finished) {
    return (
      <div className="text-center py-14 px-4 bounce-in">
        ...
        <p className="font-bold text-gray-500 mb-4" dir="rtl">סיימת את התרגול!</p>
...
const EX5_QUESTIONS: ChoiceQ[] = [
  ...
  { before: 'Gil',        after: 'a cake every Sunday.',        base: 'bake',  third: 'bakes',   answer: 'third' },
  ...
  { before: 'Dana',       after: 'her homework every day.',     base: 'do',    third: 'does',    answer: 'third' },
  { before: 'You',        after: 'a story every night.',        base: 'read',  third: 'reads',   answer: 'base'  },
  { before: 'My friends', after: 'their bikes every week.',     base: 'ride',  third: 'rides',   answer: 'base'  },
