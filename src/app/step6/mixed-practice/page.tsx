    ...
    <div className="max-w-xl mx-auto px-4 py-6 pb-16" key={key}>
      ...
      {allDone && (
        <div className="text-center bounce-in">
          ...
          <div className="mb-3"><StarOnComplete step="step6" /></div>
  ...
  if (finished) {
    return (
      <div className="text-center py-14 px-4 bounce-in">
        ...
        <p className="font-bold text-gray-500 mb-2" dir="rtl">סיימת את כל הסבבים!</p>
        <div className="mb-6"><StarOnComplete step="step6" /></div>
        <button
    ...
    <div className="min-h-screen">
      ...
      <div className="pt-4">
        ...
        {tab === 'ex5' && <RoundFlow rounds={EX5_ROUNDS.length} render={(r, done) => <TypeInExercise questions={EX5_ROUNDS[r]} onDone={done} instructionLines={[
          '1. קראו את התשובה, לפי הזמן המוצג בתשובה השלימו את השאלה.',
          '2. לאחר 2 טעויות המערכת מציגה את התשובה הנכונה – יש ללחוץ על הריבוע על מנת לעבור לשאלה הבאה.',
        ]} />} />}
      </div>
    </div>
