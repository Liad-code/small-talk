...
export default function Step5Page() {
  ...
  const step5Stars = starsFor('step5')
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="text-center py-8 px-4">
        ...
        {step5Stars > 0 && (
          <div className="inline-flex items-center gap-2 mt-4 bg-indigo-50 border-2 border-indigo-300 rounded-2xl px-4 py-2">
            <span className="text-2xl">⭐</span>
            <span className="font-black text-indigo-700 text-lg">{step5Stars} stars earned!</span>
          </div>
        )}
      </section>
