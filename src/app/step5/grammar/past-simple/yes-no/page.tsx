    ...
    <div className="max-w-xl mx-auto px-4 py-6 pb-16 flex flex-col gap-5">
      <div className="bg-blue-50 border-4 border-blue-300 rounded-3xl p-5">
        ...
        <div className="bg-white border-2 border-blue-200 rounded-2xl px-4 py-3 mb-4 text-center">
          <span className="font-bold text-gray-500 text-base">She waited.</span>
          <span className="text-blue-400 font-black mx-2">→</span>
          <span className="font-black text-blue-700 text-lg">Did she wait?</span>
        </div>

        <div className="bg-indigo-600 rounded-2xl p-3 text-center mb-4">
          <div className="font-display font-black text-white text-xl mb-1">Did</div>
          <div className="text-white/80 font-bold text-sm">+ subject + base verb?</div>
        </div>
        ...
        <div className="flex flex-col gap-1.5">
          {['Did I wait?', 'Did you wait?', 'Did he wait?', 'Did she wait?', 'Did it wait?', 'Did we wait?', 'Did they wait?'].map(s => (
      ...
      <div className="bg-amber-50 border-4 border-amber-300 rounded-3xl p-5">
        ...
        <div className="flex flex-col gap-3">
          {[
            { q: 'Did you enjoy the concert?', yes: 'Yes, I did.',    no: "No, I didn't." },
            { q: 'Did she play piano?',        yes: 'Yes, she did.',  no: "No, she didn't." },
