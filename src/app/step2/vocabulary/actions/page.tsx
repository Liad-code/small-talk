  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-4 pb-16 flex flex-col gap-5">
      ...
      <div className="bg-emerald-50 border-4 border-emerald-200 rounded-3xl overflow-hidden">
        <div className="grid grid-cols-[1.4fr_1fr_3rem] divide-x divide-emerald-200 bg-emerald-100 border-b-4 border-emerald-200">
          <div className="py-2 px-2 text-center font-bold text-emerald-700 text-xs">English</div>
          <div className="py-2 px-2 text-center font-bold text-emerald-700 text-xs" dir="rtl">עברית</div>
          <div className="py-2 text-center font-bold text-emerald-700 text-xs">Pic</div>
        </div>
        {ACTIONS.map((a, i) => (
          <div key={a.id} className={`grid grid-cols-[1.4fr_1fr_3rem] divide-x divide-emerald-200 ${i % 2 === 0 ? 'bg-white' : 'bg-emerald-50/50'}`}>
...
function Quiz2Inner({ onAgain }: { onAgain: () => void }) {
  ...
  return (
    <div className="max-w-sm mx-auto px-4 pb-16">
      ...
      <p className="text-center text-gray-500 font-bold text-sm mb-4" dir="rtl">בחר את שם הפעולה המופיעה בתמונה</p>
